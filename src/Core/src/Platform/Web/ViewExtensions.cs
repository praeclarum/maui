...
namespace Microsoft.Maui.Platform
{
	...
	{
		class HiMaui : IDisposable {
			public void Dispose() { }
		}
		public static void UpdateToolTip(this Ooui.Element platformView, ToolTip? tooltip) { }
		internal static IDisposable OnLoaded(this Ooui.Element platformView, Action action)
		{
			return new HiMaui();
		}
		internal static bool IsLoaded(this Ooui.Element platformView)
		{
			return true;
		}
		internal static IDisposable OnUnloaded(this Ooui.Element platformView, Action action)
		{
			return new HiMaui();
		}
		...
		internal static Ooui.Element? GetParent(this object? view)
		{
			return null;
		}
